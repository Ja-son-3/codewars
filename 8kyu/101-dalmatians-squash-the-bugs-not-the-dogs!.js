...
//Parameters: Given a positive non-zero integer
//Results: Return the corresponding response depending on the amount given by the parameter
//Examples:
...
//Pseudocode: 
    //1. Fix the respond variable by using template literals to return the right string from the dogs array
