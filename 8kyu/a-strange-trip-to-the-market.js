...
//Results: Return true if the given string contains the string of "tree fiddy", "3.50" or "three fifty". Otherwise return false.
//Examples:
...
//Pseudocode: 
    //1. Create an if statement that checks if the given string contains the string of "tree fiddy", "3.50" or "three fifty" using the includes method. If true return a value of true.
