...
//Parameters: Given a nested array of numbers, representing the amount of steps taken in a year.
//Results: Return the sum of all numbers within the given array.
//Examples:
...
//Pseudocode: 
    //1. Use the reduce method to iterate over the given array.
    //2. Nest another reduce method within the reduce method to iterate over nested arrays to find the sum.
    //3. Multiply the sum by 20 to get the amount of steps over 20 years and return the value.
//Time Complexity: O(n^2) or squared because of the nested loop.

function stairsIn20(s){
    return s.reduce((a,c)=>a+c.reduce((t,n)=>t+n,0),0) * 20
}